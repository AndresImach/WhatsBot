// Crea o actualiza un agente del backoffice (usuario + contraseña).
...
//
// Lee TURSO_DATABASE_URL / TURSO_AUTH_TOKEN de un .env en esta carpeta (si
// existe) o de variables ya exportadas en el shell.
...
async function main() {
  ...
  if (!process.env.TURSO_DATABASE_URL || !process.env.TURSO_AUTH_TOKEN) {
    console.error("Faltan TURSO_DATABASE_URL / TURSO_AUTH_TOKEN (poné un .env en bot/ o exportalas antes de correr esto).");
    process.exit(1);
  }
